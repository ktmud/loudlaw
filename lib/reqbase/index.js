...
module.exports = {
  ...
  // super cache
  cache: require(__dirname + '/supercache.js'),

  // filetype // format control
  ft: require(__dirname + '/middlewares/filetype.js'),

  // [send head first]
  open: require(__dirname + '/middlewares/open.js'),

  // [close the request]
  close: require(__dirname + '/middlewares/close.js'),
